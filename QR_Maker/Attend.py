...
title = tk.Label(window,text="Motor PH",bd=10,relief=tk.GROOVE,font=("times new roman",40),bg="#60607B",fg="black")
title.pack(side=tk.TOP,fill=tk.X)

Manage_Frame=Frame(window,bg="#60607B")
Manage_Frame.place(x=0,y=80,width=480,height=530)

ttk.Label(window, text = "Year",background="#60607B", foreground ="black",font = ("Times New Roman", 15)).place(x=100,y=150)
...
ttk.Label(window, text = "Branch",background="#60607B", foreground ="black",font = ("Times New Roman", 15)).place(x=100,y=200)
...
ttk.Label(window, text = "Section",background="#60607B", foreground ="black",font = ("Times New Roman", 15)).place(x=100,y=250)
...
ttk.Label(window, text = "Period",background="#60607B", foreground ="black",font = ("Times New Roman", 15)).place(x=100,y=300)
...
exit_button = tk.Button(window,width=13, text="Login",font=("Times New Roman", 15),command=checkk,bd=2,relief=RIDGE)
exit_button.place(x=300,y=380)



Manag_Frame=Frame(window,bg="#60607B")
Manag_Frame.place(x=480,y=80,width=450,height=530)

canvas = Canvas(Manag_Frame, width = 300, height = 300,background="#60607B")      
canvas.pack()      
